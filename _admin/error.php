                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                             ...
                             <?php }?>
                             <?php if ($_GET["error"]==4){?>
									<div class="alert alert-danger">No se puede eliminar una categoría que tiene subcategorías dependientes. <a href="categoria-lista.php">Volver a categorías</a></div>
                             <?php }?>
                             <?php if ($_GET["error"]==5){?>
									<div class="alert alert-danger">No se puede eliminar una categoría que tiene productos dependientes. <a href="categoria-lista.php">Volver a categorías</a><br>
<br>
Productos Relacionados:<br><br>
                           ...
                           <?php Productosdependientes($_GET["cat"])?>
                             ...
                             <?php }?>
                              <?php if ($_GET["error"]==6){?>
									<div class="alert alert-danger">Nombre SEO Repetido, debes cambiarlo.. <a href="producto-lista.php">Volver a Productos</a></div>
                             <?php }?>
                              <?php if ($_GET["error"]==7){?>
									<div class="alert alert-danger">Nombre SEO Repetido, debes cambiarlo.. <a href="categoria-lista.php">Volver a Categorías</a></div>
                             <?php }?>
