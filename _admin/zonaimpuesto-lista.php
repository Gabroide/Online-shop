...
<div class="row">
	<div class="col-lg-5">
		<a href="zonaimpuesto-add.php" class="btn btn-outline btn-primary">Añadir Zona Impuesto</a><br>
<br>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idZonaImpuesto"];?></td>
					...
					<td><a href="zonaimpuesto-edit.php?id=<?php echo $row_DatosConsulta["idZonaImpuesto"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> 	</td>
				</tr>
