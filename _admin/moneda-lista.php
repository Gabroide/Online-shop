...
<div class="row">
	<div class="col-lg-5">
		<a href="moneda-add.php" class="btn btn-outline btn-primary">Añadir Moneda</a><br>
<br>
			 ...
			 do { 
				...
				<tr>
					...
					<?php if ($row_DatosConsulta["intPrincipal"]==1) 
						...
						{
							?>
							<a href="moneda-principal.php?id=<?php echo $row_DatosConsulta["idMoneda"];?>">Hacer Principal</a>
<?php	}
						?></td>
					...
					<td><a href="moneda-edit.php?id=<?php echo $row_DatosConsulta["idMoneda"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
				</tr>
