		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td>
					<a href="comentario-aprobar.php?id=<?php echo $row_DatosConsulta["idComentario"];?>" class="btn btn-success btn-circle"><i class="fa fa-check "></i></a>
					<a href="comentario-eliminar.php?id=<?php echo $row_DatosConsulta["idComentario"];?>" class="btn btn-danger btn-circle"><i class="fa fa-times-circle "></i></a>
