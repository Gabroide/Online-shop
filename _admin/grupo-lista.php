...
<div class="row">
	<div class="col-lg-5">
		<a href="grupo-add.php" class="btn btn-outline btn-primary">Añadir Grupo</a><br>
<br>
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idGrupo"];?></td>
					...
					<td><strong><?php echo $row_DatosConsulta["strNombre"];?></strong></td>
						...
						<td></td>
						<td></td>
					<td><a href="grupo-edit.php?id=<?php echo $row_DatosConsulta["idGrupo"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> <a href="grupodetalle-add.php?id=<?php echo $row_DatosConsulta["idGrupo"];?>" class="btn btn-success btn-circle"><i class="fa fa-plus"></i></a>	</td>
				</tr>
