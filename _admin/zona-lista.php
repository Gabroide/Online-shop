			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idZona"];?></td>
					...
					<td><strong><?php echo $row_DatosConsulta["strNombre"];?></strong></td>
						...
						<td></td>
						<td></td>
					<td><a href="zona-edit.php?id=<?php echo $row_DatosConsulta["idZona"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> <a href="zonadetalle-add.php?id=<?php echo $row_DatosConsulta["idZona"];?>" class="btn btn-success btn-circle"><i class="fa fa-plus"></i></a>	</td>
				</tr>
