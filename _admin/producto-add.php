...
$esprincipal=0;
	...
	{
		$insertSQL = sprintf("INSERT INTO tblproducto(strNombre_1, strSEO_1, refCategoria1,  refCategoria2,  refCategoria3,  refCategoria4,  refCategoria5,  strImagen1, strImagen2, strImagen3, strImagen4, strImagen5, strDescripcion_1, strDescripLarga_1, strCaracteristicas_1, dblPrecio, dblPrecioAnterior, intEstado, refMarca, intPrincipal, intStock, refImpuesto, refGrupo, dblPeso) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
