		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td><a href="usuario-edit.php?id=<?php echo $row_DatosConsulta["idUsuario"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> <a href="compra-telefonica.php?id=<?php echo $row_DatosConsulta["idUsuario"];?>" class="btn btn-success btn-circle" target="_blank"><i class="fa fa-headphones "></i></a></td>
				</tr>
