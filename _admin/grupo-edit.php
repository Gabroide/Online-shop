...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblpreciogrupo SET strNombre=%s, intEstado=%s  WHERE idGrupo=%s",
       ...
       <div class="form-group">
			...
			<select name="intEstado" class="form-control" id="intEstado">
				...
				<option value="1" <?php if ($row_DatosConsulta["intEstado"]=="1") echo "selected"; ?>>Activo</option>
                                        ...
                                        <input name="idZona" type="hidden" id="idZona" value="<?php echo $row_DatosConsulta["idGrupo"];?>">
